...
Error Details : No internet connection, Server problems Or KeyboardInterrupt(Ctrl + C)                    
        ...
        # Python Tutorial
        elif persian_courses == 9:
            system('clear')
            print(Fore.LIGHTGREEN_EX + '[@] ' + Fore.LIGHTCYAN_EX + 'In this video, you  will learn basic python.')
            print(Fore.LIGHTYELLOW_EX + '[#] ' + Fore.LIGHTMAGENTA_EX + 'Teacher / Academy : Vision Academy  |  Size : 261Mb')
            print(Fore.LIGHTRED_EX + "To support free tutoring teachers, See and subscribe teachers's YouTube account :")
            print(Fore.LIGHTWHITE_EX + "Teacher's / Academy's Youtube : Account = https://youtube.com/channel/UCdJNIDb8lDrdRzPNbD7yTkQ")
            print(Fore.LIGHTWHITE_EX + 'Video Link = https://youtu.be/hSt3_2T6DMU')
            print(Fore.LIGHTBLUE_EX + 'Direct download link : https://dl.pyle-pythonlearning.ir/videos/per/Python_Tutorial_Farsi.mkv')
            print(Fore.LIGHTCYAN_EX + '------------------------------')
            # Download the Video
            WiFi_password = input(Fore.LIGHTGREEN_EX + 'Do You Wanna Download the video? (Y / N) : ')
            ...
            if WiFi_password.upper() == 'Y':
                print(Fore.LIGHTGREEN_EX + 'Please Wait, Downloading...')
                try:
                    urllib.request.urlretrieve('https://dl.pyle-pythonlearning.ir/videos/per/Python_Tutorial_Farsi.mkv', 'Python_Tutorial_Farsi.mkv')
                    print(Fore.LIGHTMAGENTA_EX + 'Done !')
                    sleep(0.5)
                    FreeCourses()
                # if there is any problems like, No internet connection or server problems :
...
11 = Create a Notepad using Python
...
Error Details : No internet connection, Server problems Or KeyboardInterrupt(Ctrl + C)                    
        ...
        # Create a NotePad using python
        elif english_courses == 11:
            system('clear')
            print(Fore.LIGHTGREEN_EX + '[@] ' + Fore.LIGHTCYAN_EX + 'This course will give you a full introduction into all of the core concepts in python.')
            print(Fore.LIGHTYELLOW_EX + '[#] ' + Fore.LIGHTMAGENTA_EX + 'Teacher / Academy : Mike Dane  |  Size : 44Mb')
            print(Fore.LIGHTRED_EX + "To support free tutoring teachers, See and subscribe teachers's YouTube account :")
            print(Fore.LIGHTWHITE_EX + "Teacher's / Academy's Youtube : Account = https://youtube.com/c/Iknowpython")
            print(Fore.LIGHTWHITE_EX + 'Video Link = https://youtu.be/qxJBXnH-F3M')
            print(Fore.LIGHTBLUE_EX + 'Direct download link : https://dl.pyle-pythonlearning.ir/videos/eng/How_to_create_Notepad_using_Python.mp4')
            print(Fore.LIGHTCYAN_EX + '------------------------------')
            # Download the Video
            LearnPython_video = input(Fore.LIGHTGREEN_EX + 'Do You Wanna Download the video? (Y / N) : ')
            ...
            if LearnPython_video.upper() == 'Y':
                print(Fore.LIGHTGREEN_EX + 'Please Wait, Downloading...')
                try:
                    urllib.request.urlretrieve('https://dl.pyle-pythonlearning.ir/videos/eng/How_to_create_Notepad_using_Python.mp4', 'How_to_create_Notepad_using_Python.mp4')
                    print(Fore.LIGHTMAGENTA_EX + 'Done !')
                    sleep(0.5)
                    FreeCourses()
                # if there is any problems like, No internet connection or server problems :
